...
final class CucumberJsonCommand implements Callable<Integer> {
    ...
    public Integer call() throws IOException {
        ...
        try (var reader = new NdjsonToMessageReader(options.sourceInputStream(), deserializer());
             var writer = MessagesToJsonWriter
                     .builder(serializer(JvmFeature[].class)::writeValue)
    ...
    private static void writeTo(MessagesToJsonWriter writer, Envelope envelope) {
        try {
